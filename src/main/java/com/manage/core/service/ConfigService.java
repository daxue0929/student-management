...
import com.manage.core.dao.ConfigMapper;
...
public class ConfigService {
    ...
    public static final String websiteName = "教务管理系统";
    ...
    public static final String yourEmail = "2365696858@qq.com";
    ...
    public int updateConfig(String configKey, String configValue) {
        return configMapper.updateByKey(configKey, configValue);
    }
    ...
    public Map<String, String> getAllConfigs() {
        ...
        Map<String, String> configMap = configs.stream().collect(Collectors.toMap(Config::getKey, Config::getValue));
        // 如果从数据库中查出来的值为空，就设置一个默认值
